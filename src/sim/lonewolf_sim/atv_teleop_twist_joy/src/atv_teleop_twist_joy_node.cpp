...
class atv_teleop_twist_joy
{
public:
	atv_teleop_twist_joy()
	{
		...
		joy_sub_ = n_.subscribe("joy", 1, &atv_teleop_twist_joy::joyCb, this);
		tim_ = n_.createTimer(ros::Duration(0.1), &atv_teleop_twist_joy::timerCb, this);
...
{
	ros::init(argc, argv, "atv_teleop_twist_joy_node");
	atv_teleop_twist_joy ob;
	ros::spin();
	return 0;
}